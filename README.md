# Домашнее задание к занятию «Управляющие конструкции в коде Terraform» - Филатов А. В.
...
### Решение 3
![alt text](disk_storage_vm.png)
![alt text](storage_vm.png)
